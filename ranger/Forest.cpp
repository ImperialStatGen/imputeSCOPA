...
Forest::Forest() :
        verbose_out(&std::cout), num_trees(DEFAULT_NUM_TREE), mtry(0), min_node_size(0), num_variables(0), num_independent_variables(
...
void Forest::writeOutput() {
  ...
  if (verbose_out) {
    ...
    *verbose_out << "ax depth         :                 " << max_depth << std::endl;
    *verbose_out << std::endl;
  }
